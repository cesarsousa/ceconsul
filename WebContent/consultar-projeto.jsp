<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <div align="center"><table width="760" cellpadding="5" border="1">
      <tr  bgcolor="#FFFFFF">    
        <td width="760">
        <ul>
        <li><p><font color="#000066" size="+2">Consultar Projeto.</font></p></li>
        </ul>
        <hr />
		<% 
        ...
        <form action="consultarProjeto">
        
        <div align="center"><p><font color="#000066">Digite o numero ou parte do nome do projeto.</font></p></div><br />   
        
        <div align="center"><input type="text" name="objeto" size="10"/></div><br />     
        
    	<div align="center"><input type="submit" value="Consultar" /></div>
