...
<%!
ArrayList<Projeto> listaDeProjetos = null;
%>
<%
listaDeProjetos=(ArrayList<Projeto>)request.getAttribute("listaDeProjetos");
%>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>CECONSUL - RELATORIO DE PROJETOS</title>
</head>
...
<table width="760" cellpadding="5" border="1">
	<tr bgcolor="#FFFFFF">
		...
		<ul>
			<li>
			<p><font color="#000066" size="+2">Consulta de Projetos.</font></p>
			</li>
		</ul>
		<hr />
		<div align="center">
		<table width="600" border="0" cellpadding="2">
			...
			<tr>
				...
				<td width="147" bgcolor="#CCCCCC">
				<a href="removerProjeto?numero=<%= projeto.getNumero() %>">REMOVER</a></td>
			</tr>
			<%
				}else{
			%>
...
<table width="760" bgcolor="#000066">
	<tr>
		<td>
		<center><b><i><font color="#CCCCCC">2010 - C e c o n s u l</font></i></b></center>
		</td>
	</tr>
</table>
</div>
